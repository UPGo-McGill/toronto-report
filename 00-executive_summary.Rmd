...
**This report analyzes short-term rentals (STRs) in the City of Toronto, with specific reference to the 2020 Covid-19 pandemic and the 2021 City regulations. It provides a general market overview of STRs in Toronto. It measures the impact of STRs on Toronto’s housing market, particularly relating to housing affordability and availability, through an assessment of the presence of commercially-operated STRs in Toronto’s areas. It assesses the impact of the City’s STR regulations on the size and character of the STR market, and assesses compliance rates among current STR operators. It measures the impact of COVID-19 on the STR market, in terms of active listings, reservations and nightly prices. And it provides an analysis of STR units that have returned to the longer-term rental market, describing their spatial distribution, asking rents, the extent to which they are commercial operations, and whether they are likely to return to the STR market when conditions improve.**

\noindent\rule{\textwidth}{1pt}

<!-- **SHORT-TERM RENTALS IN Toronto: MARKET OVERVIEW** -->

<!-- - There were 3,890 active STR listings in Toronto housing units in 2019, which collectively earned $151.4 million. -->
<!-- - A quarter of all listings are in the Downtown area. -->
<!-- - More than two thirds (69.6%) of Toronto’s STR listings are entire homes, and entire homes are responsible for 86.3% of all revenue. -->
<!-- - Revenue is concentrated unevenly among hosts, with the top 10% earning 43.2% of revenue, and the top 1% earning 13.6%, but Toronto has much less revenue concentration than other large cities in Canada. -->
...
<!-- - Short-term rentals removed 2,570 housing units from Toronto’s long-term market in 2019—an increase of 41.9% from 2018. -->
...
<!-- - Between 2015 and 2019, STRs have been responsible for a 2.1% increase in average monthly rent, and the average renter household in Toronto has paid an additional $1,390 in rent because of the impact of STRs. -->

<!-- **SHORT-TERM RENTALS IN Toronto: REGULATORY IMPACTS** -->

<!-- - The 2018 implementation of the City of Toronto's STR licensing system created a one-time negative shock in the number of STR listings in Toronto, which was disproportionately concentrated among listings which were present on STR platforms but not actively being rented. -->
<!-- - The longer-term impact of the regulations on the number of active STR listings in Toronto plausibly ranges from between 600 and 1,510 listings removed, or 14.2% to 35.8% of the total number of listings. -->
...
<!-- - Non-conforming listings are concentrated in and around Downtown Toronto; the West End is the area with the highest percentage of non-conforming listings (79.4%). -->
...
<!-- - STR activity in Toronto has suffered an unprecedented collapse during the COVID-19 pandemic. -->
...
<!-- - In total, the pandemic has reduced STR host revenue in Toronto by $130.7 million from March to September. -->
...
<!-- - These former STRs have asking rents on average 25.6% higher than other LTR listings, but are correlated with a 13.5% decrease in overall asking rents in Toronto. -->
