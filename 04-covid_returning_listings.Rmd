...
Out of the `r unique_str_matches` unique STR listings matched to LTR listings in the City of Toronto, nearly half (`r waterfront_str_match_pct`) were located in the Waterfront area, with the remaining matches more evenly split between the other wards. `r toronto_center_str_match_pct` of matches were in the Toronto Centre, following by `r uni_rosedale_match_pct` in University-Rosedale. The rests of the wards were below 6% each. This distribution is distorted compared to general distribution of STR listings in the city: the waterfront is highly over-represented in these matches. When controlling for the density of STR listings, the waterfront is still slightly over-represented with respect to the number of STRs being relisted as long-term rentals. However, other wards have a listing density close to the waterfront’s (Figure \@ref(fig:fig-6-3)). The number of STR listings matched to LTR listings in the waterfront is equivalent to more than a third (`r waterfront_match_as_pct_mar`) of all the STR listings active in the ward on March 1, 2020, and more than a fifth `r waterfront_match_as_pct_2020` of all the listings active in the borough in 2020.
