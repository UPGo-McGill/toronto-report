...
The left panel of Figure \@ref(fig:fig-6-4) shows the average asking rents of listings posted to Craigslist and Kijiji between March and December 2020, but since we do not have complete asking rent data for August and September, those months are excluded. The asking rents have remained dramatically higher than non-matched LTR listings. On March 13, when the average asking rent on LTR platforms in the City of Toronto was `r asking_rent_mar_13`, the average asking rent among listings which we matched to Airbnb was `r asking_rent_mar_13_match`— `r asking_rent_mar_13_match_dif_pct` higher. Over the course of spring 2021 and the rest of the year, average asking rents for LTR listings matched to Airbnb declined continously. At the end of December, the average asking rent was `r asking_rent_dec_31` for all Craigslist and Kijiji listings and `r asking_rent_dec_31_match` for the matches. Overall, from April to December, asking rents for properties matched to STR listings were `r rent_dif_apr_dec` higher than the city-wide average.
...
The right panel of Figure \@ref(fig:fig-6-4) shows asking rents only in the waterfront. A large portion of the divergence in asking rents between LTR listings matched to Airbnb and listings not matched is a compositional effect of the much greater frequency of a waterfront location (which commands higher prices than the rest of the city) among matched listings. Even in the waterfront, however, LTR listings matched to Airbnb have been on average `r rent_dif_apr_dec_waterfront` higher than listings not matched. Overall STRs returning to the long-term market are correlated with a significant decline in asking rents. The average city-wide asking rent on Craigslist and Kijiji declined `r rent_decline_pct` from `r asking_rent_mar` in late March 2020 to `r asking_rent_dec` in late December 2020.
