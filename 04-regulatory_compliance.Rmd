  ...
  mutate(status_10 = factor(status_10, levels = c("Inactive", "Non-commercial",
         ...
         license_status = factor(registration_analyzed, 
                                 levels = c("No license", "Fake License", "Invalid", 
                                            "Duplicates", "Exempt", "Conform", "28-day min.")))
