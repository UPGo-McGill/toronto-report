...
Monthly revenues in 2020 is not the only relevant factor to consider when looking to explain the behavior of a host moving its STR unit to the LTR market. Indeed, it may be useful to see the relative loss of monthly revenues between 2019 and 2020, again separated between the two groups previously evaluated. 
