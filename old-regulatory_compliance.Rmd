...
figure_4_4_fun <- function(regular = "", condensed = "") {
...
if (build_figures) {
  ggsave(here("output", "figures", "figure_4_4.pdf"), 
         plot = figure_4_4_fun("Futura", "Futura Condensed"), 
         width = 4, height = 4.4, units = "in", useDingbats = FALSE)
  
  extrafont::embed_fonts(here("output", "figures", "figure_4_4.pdf"))
}
